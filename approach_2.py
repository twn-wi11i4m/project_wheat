...
def approach_2(expected_yield_level='Fallow', cover_level=50):
    ...
    save_wealth_csv(farmer, date_list, res_path='res_html', title=f'approach_2_{expected_yield_level}_{cover_level}', sub_title='approach_2')

    # plot_portfolio(farmer, date_list, res_path='res_html', title='approach_2', sub_title='approach_2')
