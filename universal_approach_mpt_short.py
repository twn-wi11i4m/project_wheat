...
def universal_approach_3_years_mpt_short(start_year=2018, end_year=2020, return_farmer_only=False, benchmark_farmer=None, mpt_config=DEFAULT_MPT_CONFIG):
    ...
    if return_farmer_only:
        ...
        fig = plot_portfolio(farmer, date_list, res_path='res_html', title=f'approach_mpt_short', sub_title=f"approach 2018 ratio: {d1}, 2019 ratio: {d2}, 2020 ratio:{d3} with mpt (with short) method: {mpt_config['method']}", benchmark_farmer=benchmark_farmer)
    return fig
